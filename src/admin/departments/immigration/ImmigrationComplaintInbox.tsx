// src/admin/departments/immigration/immigrationComplaintInbox.tsx
...
export default function ImmigrationComplaintInbox({ complaints = [] }: Props) {
  console.log("📨 Immigration ComplaintInbox received complaints:", complaints);
