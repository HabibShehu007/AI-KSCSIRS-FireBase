// src/admin/departments/immigration/immigrationComplaintDetails.tsx
...
export default function ImmigrationComplaintDetails() {
  const { id } = useParams();
  ...
  const handleReply = async () => {
    ...
    setIsResolved(true);
    setTimeout(() => navigate("/admin/immigration/inbox"), 1500);
  };
