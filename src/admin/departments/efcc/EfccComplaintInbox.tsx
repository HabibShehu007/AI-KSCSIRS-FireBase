// src/admin/departments/efcc/efccComplaintInbox.tsx
...
export default function EfccComplaintInbox({ complaints = [] }: Props) {
  console.log("📨 Efcc ComplaintInbox received complaints:", complaints);
